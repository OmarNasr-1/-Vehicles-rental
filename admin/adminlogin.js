...
function login() {
    try {
        if (email.value == "" || password.value == "") {
            ...
            const url = `https://car-rental-eg.herokuapp.com/Adminsingin`;
            ...
            formEl.addEventListener("submit", async (e) => {
                ...
                try {
                    ...
                    console.log(data);
                    if (data.adminToken) {
                        localStorage.setItem('adminDate', JSON.stringify(data));
                        localStorage.setItem('adminToken', JSON.stringify(data.adminToken));
                        console.log(JSON.parse(localStorage.getItem('adminDate')));
